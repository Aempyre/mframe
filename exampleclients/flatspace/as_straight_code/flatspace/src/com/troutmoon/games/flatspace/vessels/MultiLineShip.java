...
public class MultiLineShip {
	...
	public MultiLineShip(double ix, double iy, Engine gravity_engine, FlatSpacePanel parentPanel) {
		...
		int[] xpoints = { -8,-4, 0, 5, 4, 2, 2, 8, 6, 6, 8, 2, 2, 4, 5, 0,-4,-8 };
		int[] ypoints = {  2, 4, 2, 1, 2, 2, 3, 3, 6,-6,-3,-3,-2,-2,-1,-2,-4,-2 };
		int   numpoints = 18;
