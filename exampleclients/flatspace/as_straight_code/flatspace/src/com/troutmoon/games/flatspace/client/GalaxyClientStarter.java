...
import com.troutmoon.games.flatspace.server.GalaxyProtocol;
...
public class GalaxyClientStarter {
	...
	public static void main(String[] args) {
		...
		GalaxyProtocol protocol = new GalaxyProtocol(ChannelContext.Originating_Client_Type);
		
		GalaxyClient galaxy_client = new GalaxyClient(sam, asa_id, AbstractSelectorApplication.ExpirationOrder.ACCESS_ORDER, workers, protocol);
		
		ChannelContext channel_context = new ChannelContext(ssId, srvr_addr, srvr_port, ChannelContext.Originating_Client_Type, protocol);
		channel_context.setOutboundMessage("[Client Ship Data Block]");
		
		galaxy_client.assign(channel_context);
